...
async function winData(){
  try{
    ...
    console.log("Llamando a displayDetails con datosMyApi:", datosMyApi);
    displayDetails(datosMyApi.events)
  } catch(error){
...
console.log(params); // Verifique que los parámetros se estén analizando correctamente
const id = params.get("_id");

console.log(id)
console.log(datosMyApi.events);
let detail = datosMyApi.events.find(detail => detail._id == id)
